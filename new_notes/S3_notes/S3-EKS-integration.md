# S3 EKS Integration Guide

Best practices for integrating S3 in EKS for Spring Boot Applications.

---

## Recommended Approach: IAM Roles for Service Accounts (IRSA)
...
### Step 1: Create IAM Role with S3 Access Policy
...
The IAM role should trust the EKS OIDC provider, allowing it to be assumed by a Kubernetes service account.
...
**Video Tutorial**: Configure IAM Role Trust Policy step by step
https://youtu.be/S6Pn8-bAtd8?si=afMhSbOxj6mBTllC

### Step 3: Create Kubernetes Service Account with Role Annotation
...
### Step 4: Attach Service Account to Kubernetes Deployment
...
## Optional: Spring Cloud AWS Integration
